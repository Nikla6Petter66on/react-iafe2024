      ...
      <section className="bg-white text-black py-16 px-8">
        <div className="container mx-auto text-center">
          ...
          <p className="mb-8">
            ...
            and your opportunity can flourish.
          </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            ...
            <div className="p-8 bg-white shadow-md rounded-lg">
              ...
              <p>Creative processes and ideas that lead to real results. Millions of EUR in funding acquired, million EUR deals closed, and successful new products built up multiple times.</p>
            </div>
