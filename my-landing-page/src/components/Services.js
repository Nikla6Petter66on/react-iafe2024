        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                We provide a comprehensive product roadmap, customer journey maps, and OKRs/KPIs setup to align your product vision with business goals and user needs.
              </p>
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                We create engaging user experiences through wireframes, mockups, and interactive prototypes, ensuring seamless user journeys.
              </p>
              <ul className="list-disc ml-4">
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                We build scalable, efficient full-stack applications, integrating databases and APIs for a seamless user experience.
              </p>
              <ul className="list-disc ml-4">
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                We create data architectures and integrate analytics tools, enabling you to gather insights and monitor product performance effectively.
              </p>
              <ul className="list-disc ml-4">
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                We implement agile frameworks and scalability planning to support your product's growth, ensuring efficient and effective product delivery.
              </p>
              <ul className="list-disc ml-4">
